...
with a shuffling sampler, and training on CUDA with bf16 autocast. Write your
implementation, then write a short `REPORT.md` telling the operator what you
built and anything they need to know about it.
